...
impl BoardViewSettings {
    pub fn new(block_size: f64) -> BoardViewSettings {
        BoardViewSettings {
            block_size,
...
impl GridViewSettings {
    pub fn new(board_size: f64, block_size: f64) -> GridViewSettings {
        GridViewSettings {
            board_size,
            block_size,
...
impl BoardView {
    pub fn new(board_size: f64, block_size: f64) -> BoardView {
        BoardView {
            board_settings: BoardViewSettings::new(block_size),
            grid_settings: GridViewSettings::new(board_size, block_size)
        }
    }
